...
# --- CORRECCIÓN: Usar el cliente de Subgraph ---
...
def sync_position_from_subgraph(db_session, wallet: Wallet, api_position: dict):
    """Sincroniza una posición individual desde el Subgraph a la BD."""
